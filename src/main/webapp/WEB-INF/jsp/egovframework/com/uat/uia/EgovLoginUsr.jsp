...
function fnLoginTypeSelect(objName){
		...
		var typeGnr = document.getElementById("typeGnr");
		var typeEnt = document.getElementById("typeEnt");
		var typeUsr = document.getElementById("typeUsr");
		
		if (typeGnr) typeGnr.className = "";
		if (typeEnt) typeEnt.className = "";
		if (typeUsr) typeUsr.className = "";
