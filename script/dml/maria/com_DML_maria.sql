...
-- 프로그램 관리 더미데이터
INSERT IGNORE INTO ADM_PROGRAM (
    PROGRAM_CODE,
    PROGRAM_NAME,
    START_DATE,
    END_DATE,
...
('PRG-2026-001','데이터 분석 기초','2026-03-01','2026-03-31',30,'Y','파이썬/통계 기초 과정','SYSTEM',NOW(),'SYSTEM',NOW()),
('PRG-2026-002','웹 개발 입문','2026-04-01','2026-04-30',25,'Y','HTML/CSS/JS 기초 과정','SYSTEM',NOW(),'SYSTEM',NOW()),
('PRG-2026-003','AI 프로젝트 실습','2026-05-01','2026-06-15',20,'Y','팀 프로젝트 기반 실습 과정','SYSTEM',NOW(),'SYSTEM',NOW()),
('PRG-2026-004','데이터베이스 기초','2026-06-01','2026-06-30',40,'Y','SQL 및 DB 설계 기초','SYSTEM',NOW(),'SYSTEM',NOW()),
('PRG-2026-005','클라우드 기초','2026-07-01','2026-07-31',30,'N','클라우드 개념/실습 과정','SYSTEM',NOW(),'SYSTEM',NOW());
