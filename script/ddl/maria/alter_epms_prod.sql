...
CREATE UNIQUE INDEX COMTNNTTSTATS_PK ON COMTNNTTSTATS (STATS_ID);
...
CREATE UNIQUE INDEX COMTNRECENTSRCHWRD_PK ON COMTNRECENTSRCHWRD (RECENT_SRCHWRD_ID);
...
CREATE INDEX COMTNROLES_HIERARCHY_i01 ON COMTNROLES_HIERARCHY (PARNTS_ROLE);
