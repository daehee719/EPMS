...
CREATE UNIQUE INDEX ADM_PROGRAM_PK ON ADM_PROGRAM
(
    PROGRAM_CODE
)
;

CREATE TABLE ADM_PROGRAM_STG
(
...
CREATE INDEX ADM_PROGRAM_STG_IDX1 ON ADM_PROGRAM_STG
(
    JOB_ID
)
;

CREATE TABLE ADM_UPLOAD_JOB
(
    JOB_ID               VARCHAR(50) NOT NULL,
...
(
    ...
    REG_DT               DATETIME NOT NULL,
    INDEX ADM_UPLOAD_ERROR_IDX1 (JOB_ID),
    INDEX ADM_UPLOAD_ERROR_IDX2 (ROW_NO)
)
;
